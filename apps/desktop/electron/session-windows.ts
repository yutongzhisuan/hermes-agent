...
// by main.ts (`setBackgroundThrottling` driven by the merged `xhermes:active-work`
...
// (the "XHermes idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey XHermes" wake word has NO preceding click,
