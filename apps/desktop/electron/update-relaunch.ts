...
// backend/profile/root it talks to). Anything XHERMES_DESKTOP_* is preserved
// plus XHERMES_HOME. We snapshot the values, not the live env, so the new
...
const PRESERVED_ENV_KEYS = ['XHERMES_HOME', 'ELECTRON_DISABLE_SANDBOX']
const PRESERVED_ENV_PREFIXES = ['XHERMES_DESKTOP_']
