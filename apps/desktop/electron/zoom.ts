...
export const ZOOM_STORAGE_KEY = 'xhermes:desktop:zoomLevel'
 ...
 * but forgot to emit 'xhermes:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('xhermes:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })
