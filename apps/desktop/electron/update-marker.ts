...
export function markerPath(hermesHome) {
  return path.join(hermesHome, '.xhermes-update-in-progress')
}
 ...
 *
 * The Tauri-based xhermes-setup.exe takes several seconds to initialise its
 ...
 * XHermes to exit…") clobbers that still-running updater's claim: the
