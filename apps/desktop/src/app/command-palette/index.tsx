...
import { getHermesConfigRecord, listAllProfileSessions } from '@/xhermes'
...
// XHermes session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-xhermes',
            keywords: ['update', 'upgrade', 'xhermes', 'version', 'system', 'restart'],
