...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/xhermes'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('xhermes:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('xhermes:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask XHermes to
