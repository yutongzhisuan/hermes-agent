...
const TAKEOVER_KEY = 'xhermes.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which XHermes can't clear via the API — the user
 *  sees exactly what runs instead of XHermes silently deleting their creds. */
