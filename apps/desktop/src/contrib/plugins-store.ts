 ...
 * `<xhermes home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'xhermes.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'xhermes.desktop.disabledPlugins.v1'
