...
export const en: Translations = {
  ...
  boot: {
    ready: 'XHermes Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading XHermes settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting XHermes Desktop…'
    },
    errors: {
      backgroundExited: 'XHermes background process exited.',
      backgroundExitedDuringStartup: 'XHermes background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your XHermes backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update XHermes',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting XHermes Desktop.',
    ...
    native: {
      ...
      inputBody: 'XHermes is waiting for your response.',
      turnDoneTitle: 'XHermes finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to XHermes defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while XHermes is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'XHermes asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while XHermes was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let XHermes follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and XHermes can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what XHermes is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen XHermes, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'XHermes checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading XHermes configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening XHermes.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a XHermes backend elsewhere. Per-profile overrides below.',
      ...
      remoteDesc: 'Connect this desktop shell to a remote XHermes backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'XHermes Cloud',
      cloudDesc: 'Sign in once to XHermes Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'XHermes Cloud',
      cloudSignIn: 'Sign in to XHermes Cloud',
      cloudSignedIn: 'Signed in to XHermes Cloud',
      cloudNeedsSignIn: 'Sign in to XHermes Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your XHermes Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'XHermes Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of XHermes Cloud',
      cloudSignedOutMessage: 'Cleared the XHermes Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /xhermes.',
      ...
      restartingMessage: 'XHermes Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · XHermes ${version}` : ''}`,
      ...
      sshDesc:
        'XHermes is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'XHermes path (optional)',
      sshHermesPathDesc: 'Full path to the remote xhermes binary. Blank = auto-detect.',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — XHermes found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — XHermes runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'XHermes is not installed on the remote host. Install it there (curl -fsSL https://raw.githubusercontent.com/yutongzhisuan/xhermes-agent/main/scripts/install.sh | sh) or set the XHermes path.',
      sshErrPlatform:
        'Unsupported remote platform. XHermes Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update XHermes on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. XHermes runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point XHermes at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via xhermes curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As XHermes builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart XHermes to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update XHermes to generate pets.',
      backgroundHint: 'You can close this — XHermes will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure XHermes desktop' },
    ...
    hermesActiveSessions: (version, count) => `XHermes ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@xhermes:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent XHermes environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. XHermes will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the XHermes backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from XHermes. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting XHermes...',
    placeholderReconnecting: 'Reconnecting to XHermes…',
    ...
    attachUrlDesc: 'XHermes will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask XHermes to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating XHermes…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting XHermes…',
    ...
    unsupportedMessage: 'This version of XHermes can’t update itself from inside the app.',
    ...
    manualBody: 'You installed XHermes from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'XHermes will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the XHermes desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The XHermes updater takes over in its own window and reopens XHermes automatically when it’s done. Please don’t reopen XHermes yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. XHermes reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then XHermes reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'XHermes needs a one-time install',
    ...
    setupChoiceTitle: 'Set up XHermes Desktop',
    setupChoiceDesc:
      'Connect this app to a XHermes gateway you already run, or install XHermes locally on this computer.',
    connectExistingTitle: 'Connect to existing XHermes',
    ...
    installLocalTitle: 'Install XHermes locally',
    installLocalDesc: 'Download XHermes, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart XHermes Desktop and try again.',
    remoteSetupTitle: 'Connect to existing XHermes',
    remoteSetupDesc: 'Enter your gateway URL. XHermes Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the XHermes gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/xhermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that XHermes gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up XHermes Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another XHermes CLI or desktop instance is running. Stop any running XHermes instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with XHermes Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'XHermes is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting XHermes…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run XHermes',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point XHermes at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — XHermes connects automatically',
    ...
    authorizeThere: 'Authorize XHermes there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize XHermes there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `XHermes Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `XHermes Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. XHermes will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'XHermes is restarting...',
      askRestart: 'Ask XHermes to restart the server',
      lookingRestart: taskId => `XHermes is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'XHermes is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `XHermes finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'XHermes could not restart the server.',
      stillWorking:
        'XHermes is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'XHermes is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'XHermes gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.xhermes/config.yaml). XHermes won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'XHermes needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'XHermes needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart XHermes Desktop to use Save Image.',
    restartToSaveImages: 'Restart XHermes Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `xhermes gateway` running?'
    }
  },
