...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        'Hermes is not installed on the remote host. Install it there (curl -fsSL https://raw.githubusercontent.com/yutongzhisuan/xhermes-agent/main/scripts/install.sh | sh) or set the Hermes path.',
      sshErrPlatform:
