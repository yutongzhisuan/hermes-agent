...
const XHERMES_REF_TYPES = WIRE_REFERENCE_KINDS
type HermesRefType = (typeof XHERMES_REF_TYPES)[number]
...
const XHERMES_DIRECTIVE_RE = referenceRe()
...
function parseDirectiveText(text: string): Unstable_DirectiveSegment[] {
  const matches = [
    ...
    ...Array.from(text.matchAll(XHERMES_DIRECTIVE_RE)).map(match => {
...
/**
 * Renders text containing XHermes directives (`@file:...`, `@image:...`) as
