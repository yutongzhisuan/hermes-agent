...
import { getProfiles, setApiRequestProfile, STARTUP_REQUEST_TIMEOUT_MS } from '@/xhermes'
...
import type { ProfileInfo } from '@/types/xhermes'
...
// /api/profiles/active `current`). "default" is the root ~/.xhermes. This is the
...
const PROFILE_ORDER_STORAGE_KEY = 'xhermes.desktop.profileOrder'
...
const PROFILE_COLORS_STORAGE_KEY = 'xhermes.desktop.profileColors'
...
// Persist the choice and relaunch the backend under the new XHERMES_HOME. The
...
const SHOW_ALL_PROFILES_STORAGE_KEY = 'xhermes.desktop.showAllProfiles'
...
// Switch to the default (root ~/.xhermes) profile — bound to ⌘1.
