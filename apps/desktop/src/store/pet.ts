...
export interface PetInfo {
  ...
  // the XHermes "run" activity state uses the in-place running row).
 ...
 * XHERMES_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'xhermes.desktop.pet-roam.v1'
