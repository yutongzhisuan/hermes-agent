...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @xhermes/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@xhermes/shared'],
              message: 'Plugins import only @xhermes/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
