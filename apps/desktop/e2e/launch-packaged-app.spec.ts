...
/**
 * E2E smoke tests for the packaged XHermes desktop app.
 *
 ...
 * (credential stripping, isolated XHERMES_HOME + userData, unique app name).
 *
...
test('window opens with the XHermes title', async () => {
