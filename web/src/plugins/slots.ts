 ...
 * `window.__XHERMES_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the XHermes brand in the top bar
 ...
 *  `window.__XHERMES_PLUGINS__.registerSlot(...)`.
 *
