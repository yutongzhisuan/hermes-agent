...
const STORAGE_KEY = "xhermes-dashboard-theme";
...
const FONT_STORAGE_KEY = "xhermes-dashboard-font";
...
const CUSTOM_CSS_STYLE_ID = "xhermes-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-xhermes-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-xhermes-theme-font", "true");
