...
_APP_VERSION = _XHERMES_VERSION
_BOT_VERSION = _XHERMES_VERSION
_YUANBAO_INSTANCE_ID = str(XHERMES_INSTANCE_ID)  # single source: yuanbao_proto.XHERMES_INSTANCE_ID
