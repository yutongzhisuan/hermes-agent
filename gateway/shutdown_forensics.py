...
def check_systemd_timing_alignment(drain_timeout: float) -> Optional[Dict[str, Any]]:
    ...
    upgraded xhermes-agent but never re-ran ``xhermes setup`` to regenerate
    ...
    try:
        # /proc/self/cgroup gives us "0::/user.slice/.../xhermes-gateway.service"
    ...
    # that's the common case for xhermes.
