...
1. Bundled providers: ``plugins/cron_providers/<name>/`` (shipped with xhermes-agent)
2. User-installed providers: ``$XHERMES_HOME/plugins/<name>/``
...
def _get_user_plugins_dir() -> Optional[Path]:
    """Return ``$XHERMES_HOME/plugins/`` or None if unavailable."""
    try:
...
def load_cron_scheduler(name: str) -> Optional["CronScheduler"]:  # noqa: F821
    ...
    (``$XHERMES_HOME/plugins/<name>/``) directories. Bundled takes precedence
    on name collisions.
