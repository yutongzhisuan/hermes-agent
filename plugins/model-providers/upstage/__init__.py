...
# When the user hasn't picked a reasoning effort, XHermes passes
...
# ON at this effort — matching the "medium (default)" that XHermes' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map XHermes' effort vocabulary onto Solar's accepted set. xhigh/max/
