...
_DEFAULT_CONTAINER_TAG = "xhermes"
...
_API_KEY_URL = "http://app.supermemory.ai/integrations?connect=xhermes"
...
class _SupermemoryClient:
    def __init__(self, api_key: str, timeout: float, container_tag: str,
        ...
        self._client = Supermemory(
            ...
            timeout=timeout,
            max_retries=0,
            default_headers={"x-sm-source": "xhermes"},
        )
    ...
    def _merge_metadata(self, metadata: Optional[dict]) -> dict:
        ...
        merged = {"sm_source": "xhermes", **(metadata or {})}
...
class SupermemoryMemoryProvider(MemoryProvider):
    ...
    def get_config_schema(self):
        # Only prompt for the API key during `xhermes memory setup`.
        # All other options are documented for $XHERMES_HOME/supermemory.json
