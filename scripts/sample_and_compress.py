...
DEFAULT_DATASETS = [
    ...
    "NousResearch/xhermes-agent-megascience-sft1",
    "NousResearch/XHermes-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/XHermes-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-xhermes-agent"
]
