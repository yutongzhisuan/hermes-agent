...
Built for [XHermes Agent](https://github.com/NousResearch/xhermes-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/xhermes-agent/skills/creative/ascii-video`](https://github.com/NousResearch/xhermes-agent/tree/main/skills/creative/ascii-video) via PR.
