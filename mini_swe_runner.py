#!/usr/bin/env python3
"""
SWE Runner with XHermes Trajectory Format

A runner that uses XHermes-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the XHermes-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses XHermes-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in XHermes format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches XHermes-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using XHermes-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with XHermes Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses XHermes-Agent's built-in execution environments
    and outputs trajectories in XHermes-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to XHermes trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to XHermes trajectory format
...
def main(
    ...
    """
    Run SWE tasks with XHermes trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with XHermes Trajectory Format")
    print("=" * 60)
