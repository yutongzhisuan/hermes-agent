...
def mask_secret(
    ...
    *,
    ...
    Canonical helper for display-time redaction across XHermes — used by
    ``xhermes config``, ``xhermes status``, ``xhermes dump``, and anywhere
...
def redact_sensitive_text(
    ...
    *,
    ...
    for URLs, ``"eyJ" in text`` for JWTs). On a typical xhermes log line
