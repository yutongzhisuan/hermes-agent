...
XHERMES_KANBAN_* variables in process env. delegate_task children run inside the
...
DELEGATED_CHILD_ENV_MARKER = "XHERMES_DELEGATED_CHILD_CONTEXT"
...
def delegated_child_subprocess_env(
    ...
    parent dispatcher ``XHERMES_KANBAN_*`` vars while losing the ContextVar in
