...
Optional hooks (override to opt in):
  ...
  backup_paths() -> list[str]            — extra on-disk paths to include in `xhermes backup`
"""
...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "xhermes").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'xhermes memory setup' to walk the user through configuration.
    ...
    def backup_paths(self) -> List[str]:
        ...
        of the archive, and ``xhermes import`` restores them to their original
