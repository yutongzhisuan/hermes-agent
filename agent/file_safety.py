...
def get_read_block_error(path: str) -> Optional[str]:
    ...
    Three categories are blocked:
      ...
      * Internal XHermes cache files under ``HERMES_HOME/skills/.hub`` —
        readable metadata that an attacker could use as a prompt-injection
        carrier.
      * Credential / secret stores under HERMES_HOME and the global XHermes
...
#
# XHermes profiles are separate HERMES_HOME dirs under
...
#
#   <HERMES_HOME>/profiles/<name>/sandboxes/<backend>/<task>/home/.xhermes/...
#
