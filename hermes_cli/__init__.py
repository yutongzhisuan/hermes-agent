"""
XHermes CLI - Unified command-line interface for xHermes Agent.

Provides subcommands for:
- xhermes chat          - Interactive chat (same as ./xhermes)
- xhermes gateway       - Run gateway in foreground
- xhermes gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `xhermes setup` on a fresh Pi.
