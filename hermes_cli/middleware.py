"""XHermes middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "xhermes.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "xhermes.middleware.v1"
...
def apply_llm_request_middleware(
    ...
    **context: Any,
    ...
    provider kwargs before XHermes sends them.
    """
