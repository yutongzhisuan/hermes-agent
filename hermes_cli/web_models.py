"""Pydantic request/response models for the XHermes dashboard web server.
...
class ModelAssignment(BaseModel):
    ...
    # ``xhermes model`` custom flow collects.
    api_key: str = ""
...
class ImportRequest(BaseModel):
    archive: str
    # Pass --force to `xhermes import`. The spawned action runs with
