...
TIPS = [
    ...
    "Profiles scope XHermes state via HERMES_HOME; host tool subprocesses keep your real HOME unless terminal.home_mode is profile.",
    ...
    'HERMES_ENABLE_PROJECT_PLUGINS=1 auto-loads repo-local plugins from ./.xhermes/plugins/ — trust-gated by design.',
