...
Entry point: ``xhermes whatsapp-cloud`` (dispatched from
...
XHermes gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures XHermes to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  XHermes needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the XHermes gateway in another terminal:")
    print("         xhermes gateway")
    print()
    ...
    print()
    print("  Docs: https://xhermes-agent.nousresearch.com/docs/user-guide/")
