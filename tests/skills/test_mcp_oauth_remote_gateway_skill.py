...
SESSION_REVOKED / REFRESH_DEAD), the XHERMES_HOME resolution fallback, the
...
def _run_main(mod, tokens_dir, argv, responses):
    ...
    with patch.object(mod.os, "environ", dict(mod.os.environ, XHERMES_HOME=str(tokens_dir.parent))), \
