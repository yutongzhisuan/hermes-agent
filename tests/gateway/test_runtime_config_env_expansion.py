...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("XHERMES_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("XHERMES_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("XHERMES_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
