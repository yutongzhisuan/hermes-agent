...
class TestBackendSelection:
    ...
    ``xhermes tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
...
class TestFirecrawlEnvResolution:
    ...
    values stored in ~/.xhermes/.env were invisible to the provider."""
...
class TestSiblingProvidersEnvResolution:
    ...
    ~/.xhermes/.env), not bare os.getenv. Parametrized over the four
