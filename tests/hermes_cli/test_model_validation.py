...
class TestProbeApiModelsUserAgent:
    """Probing custom /v1/models must send a XHermes User-Agent.
    ...
    def test_probe_sends_hermes_user_agent(self):
        ...
        assert ua.startswith("xhermes-cli/"), (
            f"User-Agent must advertise xhermes-cli, got {ua!r}"
        )
    ...
    def test_probe_user_agent_sent_without_api_key(self):
        ...
        assert ua and ua.startswith("xhermes-cli/")
