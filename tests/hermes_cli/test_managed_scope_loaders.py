...
def test_timezone_honors_managed(homes, monkeypatch):
    ...
    monkeypatch.delenv("XHERMES_TIMEZONE", raising=False)
...
def test_gateway_env_bridge_honors_managed(homes, monkeypatch):
    ...
    every turn (XHERMES_TIMEZONE, XHERMES_REDACT_SECRETS, XHERMES_MAX_ITERATIONS,
    ...
    # writing XHERMES_TIMEZONE = cfg["timezone"]. Prove the overlay flips the value.
    import yaml
