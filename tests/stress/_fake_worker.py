...
Reads XHERMES_KANBAN_TASK from env, heartbeats periodically, does short
...
def main():
    tid = os.environ["XHERMES_KANBAN_TASK"]
    workspace = os.environ.get("XHERMES_KANBAN_WORKSPACE", "")
