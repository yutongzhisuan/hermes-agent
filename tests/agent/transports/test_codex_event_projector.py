"""Tests for CodexEventProjector — codex item/* events → XHermes messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks XHermes' message alternation invariant."""
