...
See: https://github.com/NousResearch/xhermes-agent/issues/25114
See: https://github.com/NousResearch/xhermes-agent/issues/36144
See: https://github.com/NousResearch/xhermes-agent/issues/29015
"""
...
class TestGetSubprocessHome:
    ...
    def test_host_auto_keeps_real_home_when_profile_home_exists(self, tmp_path, monkeypatch):
        ...
        hermes_home = real_home / ".xhermes" / "profiles" / "coder"
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        self._container_mode(monkeypatch)
        base = tmp_path / ".xhermes" / "profiles"
