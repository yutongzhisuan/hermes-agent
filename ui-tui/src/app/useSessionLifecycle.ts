...
import type { ScrollBoxHandle } from '@xhermes/ink'
import { evictInkCaches } from '@xhermes/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.XHERMES_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
