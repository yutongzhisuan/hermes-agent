import type { BillingBlock, UsageModelData } from '@xhermes/shared/billing'
import type { HermesSkin } from '@xhermes/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@xhermes/shared`).
...
// Wire shapes now live in @xhermes/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
