      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via XHERMES_BUNDLED_SKILLS /
            # XHERMES_OPTIONAL_SKILLS (see xhermes-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + XHERMES_BUNDLED_LOCALES
            # / XHERMES_OPTIONAL_MCPS, not via the wheel. Excluding them
