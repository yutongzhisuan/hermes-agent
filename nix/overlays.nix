# nix/overlays.nix — Expose pkgs.xhermes-agent for external NixOS configs
#
...
# `pkgs.xhermes-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    xhermes-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
