#!/usr/bin/env python3
"""Start a TLS/mTLS Task Relay Hub + stub worker for Go Master mTLS tests."""
...
from extend.task_relay.hub.tls import TlsConfig, load_server_ssl_context
...
async def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        server_ssl = load_server_ssl_context(
            TlsConfig(
        ...
        master_jwt = auth.issue_master_jwt("go-mtls-master", ttl_s=3600)
