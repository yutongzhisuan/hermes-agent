...
# optimized via ``xhermes sessions optimize-storage``. A legacy DB sits at
...
# `xhermes sessions optimize-storage` rebuilds it on a capable host.
...
# triggers repairable UNTIL the user opts into `xhermes db optimize`. This is
