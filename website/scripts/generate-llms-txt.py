#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the XHermes docs site.
...
Both publish at:
  https://xhermes-agent.nousresearch.com/docs/llms.txt
  https://xhermes-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://xhermes-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use XHermes as a Python Library", None),
        ("guides/use-mcp-with-xhermes", "Use MCP with XHermes", None),
        ("guides/use-voice-mode-with-xhermes", "Use Voice Mode with XHermes", None),
        ("guides/use-soul-with-xhermes", "Use SOUL.md with XHermes", None),
        ("guides/build-a-xhermes-plugin", "Build a XHermes Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with XHermes"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "xhermes-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/xhermes-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# XHermes Agent — Full Documentation\n",
        (
            "This file is the entire XHermes Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using XHermes, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://xhermes-agent.nousresearch.com/docs\n",
        "Short index: https://xhermes-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
