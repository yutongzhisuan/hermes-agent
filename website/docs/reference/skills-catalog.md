...
| [`xhermes-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-xhermes-agent) | Use, configure, theme, extend, and orchestrate XHermes Agent. | `autonomous-ai-agents/xhermes-agent` |
...
| [`xhermes-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-xhermes-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/xhermes-agent-skill-authoring` |
| [`inspecting-xhermes-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-xhermes-desktop-dom) | Read the live XHermes desktop DOM/CSS over CDP. | `software-development/inspecting-xhermes-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .xhermes/plans/; no execution. | `software-development/plan` |
