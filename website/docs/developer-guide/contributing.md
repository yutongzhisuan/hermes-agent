...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to XHermes Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to XHermes Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying XHermes core? Start with [Build a XHermes Plugin](../developer-guide/plugins/index.md)
- Building a new built-in core tool for XHermes itself? Start with [Adding Tools](./adding-tools.md)
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.xhermes/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.xhermes` — use `get_hermes_home()` from `hermes_constants` for code paths and `display_hermes_home()` for user-facing messages. See [AGENTS.md](https://github.com/NousResearch/xhermes-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/NousResearch/xhermes-agent/blob/main/LICENSE).
