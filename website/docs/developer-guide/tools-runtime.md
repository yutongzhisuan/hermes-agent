...
XHermes tools are self-registering functions grouped into toolsets and executed through a central registry/dispatch system.
...
Toolsets are named bundles of tools. XHermes resolves them through:

- explicit enabled/disabled toolset lists
- platform presets (`xhermes-cli`, `xhermes-telegram`, etc.)
- dynamic MCP toolsets
- curated special-purpose sets like `xhermes-acp`
