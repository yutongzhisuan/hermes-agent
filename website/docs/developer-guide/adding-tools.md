...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to XHermes Agent — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in XHermes tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying XHermes core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build a XHermes Plugin](/developer-guide/plugins)
...
- [ ] Tested with `xhermes chat -q "Use the weather tool for London"`
