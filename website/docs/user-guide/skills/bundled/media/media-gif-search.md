...
Set your Tenor API key in your environment (add to `${XHERMES_HOME:-~/.xhermes}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/xhermes-agent/blob/main/skills/media/gif-search/url)`
