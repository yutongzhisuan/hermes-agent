...
| | |
|---|---|
| Source | Optional — install with `xhermes skills install official/mlops/segment-anything-model` |
...
- **[Advanced Usage](https://github.com/NousResearch/xhermes-agent/blob/main/optional-skills/mlops/models/segment-anything-model/references/advanced-usage.md)** - Batching, fine-tuning, integration
- **[Troubleshooting](https://github.com/NousResearch/xhermes-agent/blob/main/optional-skills/mlops/models/segment-anything-model/references/troubleshooting.md)** - Common issues and solutions
