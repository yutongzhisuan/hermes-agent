...
| | |
|---|---|
| Source | Optional — install with `xhermes skills install official/research/gitnexus-explorer` |
...
| Related skills | [`xhermes-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-xhermes-agent), [`codebase-inspection`](/docs/user-guide/skills/bundled/github/github-codebase-inspection) |
