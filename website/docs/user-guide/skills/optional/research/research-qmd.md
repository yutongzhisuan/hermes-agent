...
| | |
|---|---|
| Source | Optional — install with `xhermes skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`xhermes-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-xhermes-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
XHermes Agent via the native MCP client. This is the preferred
...
Then configure XHermes Agent to connect via HTTP:
