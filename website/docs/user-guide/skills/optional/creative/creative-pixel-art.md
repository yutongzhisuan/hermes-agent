...
| | |
|---|---|
| Source | Optional — install with `xhermes skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.xhermes/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.xhermes/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — XHermes installs package this)
