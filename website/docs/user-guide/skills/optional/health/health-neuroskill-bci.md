...
| | |
|---|---|
| Source | Optional — install with `xhermes skills install official/health/neuroskill-bci` |
...
Connect XHermes to a running [NeuroSkill](https://neuroskill.com/) instance to read
