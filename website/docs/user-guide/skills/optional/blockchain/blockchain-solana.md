...
| | |
|---|---|
| Source | Optional — install with `xhermes skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by XHermes Agent |
| License | MIT |
...
Helper script path: ~/.xhermes/skills/blockchain/solana/scripts/solana_client.py
