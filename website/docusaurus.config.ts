...
const config: Config = {
  ...
  url: 'https://xhermes-agent.nousresearch.com',
  baseUrl: '/docs/',

  organizationName: 'NousResearch',
  projectName: 'xhermes-agent',
      ...
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          },
          {
            ...
            from: '/guides/build-a-xhermes-plugin',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/NousResearch/xhermes-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/xhermes-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://xhermes-agent.nousresearch.com/',
          label: 'Download',
          position: 'left',
        },
        {
        ...
        {
          href: 'https://github.com/NousResearch/xhermes-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/NousResearch/xhermes-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://xhermes-agent.nousresearch.com/' },
            { label: 'GitHub', href: 'https://github.com/NousResearch/xhermes-agent' },
