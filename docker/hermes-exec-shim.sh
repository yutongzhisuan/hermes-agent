#!/bin/sh
# shellcheck shell=sh
# /opt/xhermes/bin/xhermes — `docker exec` privilege-drop shim.
#
# Background
# ----------
...
# Root, no opt-out. Drop to the xhermes user.
#
...
# Reset HOME to the xhermes user's home before dropping privileges. Without
