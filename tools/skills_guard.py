...
Trust levels:
  - builtin:   Ships with XHermes. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.xhermes/\.env|\~/\.xhermes/\.env',
     "hermes_env_access", "critical", "exfiltration",
     "directly references XHermes secrets file"),
    ...
    (r'\.xhermes/config\.yaml|\.xhermes/SOUL\.md',
     "hermes_config_mod", "critical", "persistence",
     "references XHermes configuration files directly"),
...
# scan. `.skillignore` is the XHermes-native name; `.clawhubignore` is honored
