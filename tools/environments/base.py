"""Base class for all XHermes execution environment backends.
...
class BaseEnvironment(ABC):
    """Common interface and unified execution flow for all XHermes backends.
    ...
    def __init__(self, cwd: str, timeout: int, env: dict = None):
        ...
        self._snapshot_path = f"{temp_dir}/xhermes-snap-{self._session_id}.sh"
        self._cwd_file = f"{temp_dir}/xhermes-cwd-{self._session_id}.txt"
    ...
    def _wrap_command(self, command: str, cwd: str) -> str:
        ...
        # Restrict XHermes metadata files without changing the user's command
