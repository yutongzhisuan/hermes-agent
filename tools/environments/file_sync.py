...
_FORCE_SYNC_ENV = "XHERMES_FORCE_FILE_SYNC"
...
def iter_sync_files(container_base: str = "/root/.xhermes") -> list[tuple[str, str]]:
    ...
    the hardcoded /root/.xhermes to *container_base* because the remote
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``XHERMES_FORCE_FILE_SYNC=1`` is set.
    ...
    def sync_back(self, hermes_home: Path | None = None) -> None:
        ...
        Downloads the remote ``.xhermes/`` directory as a tar archive,
        ...
        # against an uninitialized remote .xhermes/ directory.
    ...
    def _sync_back_impl(self) -> None:
        ...
        with tempfile.NamedTemporaryFile(suffix=".tar") as tf:
            ...
            with tempfile.TemporaryDirectory(prefix="xhermes-sync-back-") as staging:
    ...
    def _infer_host_path(self, remote_path: str,
        ...
        For example, if the mapping has ``/root/.xhermes/skills/a.md`` →
        ``~/.xhermes/skills/a.md``, a new remote file at
        ``/root/.xhermes/skills/b.md`` maps to ``~/.xhermes/skills/b.md``.
        """
        mapping = file_mapping if file_mapping is not None else []
