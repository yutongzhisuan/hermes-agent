...
class SSHEnvironment(BaseEnvironment):
    ...
    def __init__(self, host: str, user: str, cwd: str = "~",
        ...
        self.control_dir = Path(tempfile.gettempdir()) / "xhermes-ssh"
    ...
    def _ensure_remote_dirs(self) -> None:
        """Create base ~/.xhermes directory tree on remote in one SSH call."""
        base = f"{self._remote_home}/.xhermes"
    ...
    def _ssh_bulk_upload(self, files: list[tuple[str, str]]) -> None:
        ...
        with tempfile.TemporaryDirectory(prefix="xhermes-ssh-bulk-") as staging:
    ...
    def _ssh_bulk_download(self, dest: Path) -> None:
        ...
        # paths (e.g. home/user/.xhermes/skills/f.py), matching _pushed_hashes keys.
