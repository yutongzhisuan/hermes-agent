...
Data file: $XHERMES_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_XHERMES_HOME = Path(os.environ.get("XHERMES_HOME", Path.home() / ".xhermes"))
DATA_DIR = _XHERMES_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
